...
Titre de section : Administration fonctionnelle
Identifiant de section : user-functional-administration
But : Présenter la gestion fonctionnelle des comptes lorsque démontrée.
Budget de contexte estimé : 242/8192 tokens.
Produis uniquement la section demandée, sans titre de document global, sans conclusion générale et sans contenu hors sujet.
END INSTRUCTIONS

BEGIN SECTION FACTS
{
  "identifier": "user-functional-administration",
  "title": "Administration fonctionnelle",
  "purpose": "Présenter la gestion fonctionnelle des comptes lorsque démontrée.",
  "facts": {
    "user_view": {
      "application": {
        "name": null,
      ...
      "local_encrypted_vault": false,
      "lock_behavior": null,
      "unlock_behavior": null,
      "recovery": "Aucune procédure de récupération n’est démontrée.",
      "security_guidance": []
    }
  }
}
