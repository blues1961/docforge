...
Identifiant de section : user-authentication
But : Expliquer les mécanismes d’authentification démontrés sans procédure technique.
Budget de contexte estimé : 236/8192 tokens.
...
BEGIN SECTION FACTS
{
  ...
  "purpose": "Expliquer les mécanismes d’authentification démontrés sans procédure technique.",
  "facts": {
    "user_view": {
      "application": {
        "name": null,
