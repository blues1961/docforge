...
Titre de section : Public visé et rôles
Identifiant de section : user-roles
But : Distinguer les utilisateurs et l’administration fonctionnelle.
Budget de contexte estimé : 271/8192 tokens.
...
BEGIN SECTION FACTS
{
  ...
  "title": "Public visé et rôles",
  "purpose": "Distinguer les utilisateurs et l’administration fonctionnelle.",
  "facts": {
    "user_view": {
      "application": {
        "name": null,
