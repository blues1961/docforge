...
Titre de section : Accès à l’application
Identifiant de section : user-access
But : Indiquer uniquement les accès d’interface démontrés.
Budget de contexte estimé : 166/8192 tokens.
...
BEGIN SECTION FACTS
{
  ...
  "purpose": "Indiquer uniquement les accès d’interface démontrés.",
  "facts": {
    "user_view": {
      "application": {
        "name": null,
