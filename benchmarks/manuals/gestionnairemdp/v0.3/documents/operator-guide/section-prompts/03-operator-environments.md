...
Budget de contexte estimé : 709/12288 tokens.
      ...
      "endpoints": [
        {
          "environment": "dev",
          "service": "backend",
          "url": "http://localhost:${DEV_API_PORT:-8002}/api/",
          "validity": "valid",
        ...
        },
        {
          "environment": "dev",
          "service": "backend",
          "url": "http://localhost:${DEV_API_PORT:-8002}/admin/",
          "validity": "valid",
          "resolution_status": "resolved"
        },
        {
          "environment": "dev",
          "service": "frontend",
          "url": "http://localhost:${DEV_VITE_PORT:-5174}",
          "validity": "valid",
          "resolution_status": "resolved"
        },
        {
        ...
        },
        {
          "environment": "prod",
          "service": "backend",
          "url": "https://mdp.mon-site.ca/admin/",
          "validity": "valid",
          "resolution_status": "resolved"
        },
        {
