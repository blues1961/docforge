...
But : Présenter l’application et son objectif fonctionnel démontré.
Budget de contexte estimé : 52/12288 tokens.
...
BEGIN SECTION FACTS
{
  ...
  "title": "Présentation",
  "purpose": "Présenter l’application et son objectif fonctionnel démontré.",
  "facts": {
    "user_view": {
      "application": {
