...
Titre de section : Déploiement
Identifiant de section : operator-deployment
But : Présenter les éléments de production démontrés.
Budget de contexte estimé : 2773/12288 tokens.
Produis uniquement la section demandée, sans titre de document global, sans conclusion générale et sans contenu hors sujet.
END INSTRUCTIONS

BEGIN SECTION FACTS
{
  "identifier": "operator-deployment",
  "title": "Déploiement",
  "purpose": "Présenter les éléments de production démontrés.",
  "facts": {
    "environments": {
      "items": [
        {
