...
Titre de section : Commandes Make
Identifiant de section : operator-make-commands
But : Fournir la référence déterministe des cibles Make publiques.
Budget de contexte estimé : 1586/12288 tokens.
Produis uniquement la section demandée, sans titre de document global, sans conclusion générale et sans contenu hors sujet.
END INSTRUCTIONS

BEGIN SECTION FACTS
{
  "identifier": "operator-make-commands",
  "title": "Commandes Make",
  "purpose": "Fournir la référence déterministe des cibles Make publiques.",
  "facts": {
