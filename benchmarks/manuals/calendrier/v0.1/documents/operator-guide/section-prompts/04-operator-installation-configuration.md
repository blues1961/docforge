...
Titre de section : Installation et configuration
Identifiant de section : operator-installation-configuration
But : Présenter la configuration et les séquences démontrées.
Budget de contexte estimé : 1059/12288 tokens.
Produis uniquement la section demandée, sans titre de document global, sans conclusion générale et sans contenu hors sujet.
END INSTRUCTIONS

BEGIN SECTION FACTS
{
  "identifier": "operator-installation-configuration",
  "title": "Installation et configuration",
  "purpose": "Présenter la configuration et les séquences démontrées.",
  "facts": {
    "installation": {
