...
Titre de section : Sécurité pour l’utilisateur
Identifiant de section : user-security
But : Présenter les protections pertinentes pour l’utilisateur.
Budget de contexte estimé : 153/12288 tokens.
...
BEGIN SECTION FACTS
{
  ...
  "title": "Sécurité pour l’utilisateur",
  "purpose": "Présenter les protections pertinentes pour l’utilisateur.",
  "facts": {
    "user_view": {
