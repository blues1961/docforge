...
Titre de section : Environnements développement et production
Identifiant de section : operator-environments
But : Comparer les environnements détectés.
Budget de contexte estimé : 668/12288 tokens.
Produis uniquement la section demandée, sans titre de document global, sans conclusion générale et sans contenu hors sujet.
END INSTRUCTIONS

BEGIN SECTION FACTS
{
  "identifier": "operator-environments",
  "title": "Environnements développement et production",
  "purpose": "Comparer les environnements détectés.",
  "facts": {
    "environments": {
      "items": [
        {
        ...
        },
        {
          ...
          "urls": [
            "https://cal.mon-site.ca",
            "https://cal.mon-site.ca/admin/",
            "https://cal.mon-site.ca/api/",
            "https://cal.mon-site.ca/static/"
          ],
          "services": [
            {
              "name": "backend",
      ...
      "endpoints": [
        {
          "environment": "dev",
          "service": "backend",
          "url": "http://localhost:${DEV_API_PORT}/api/",
          "validity": "valid",
        ...
        },
        {
          "environment": "dev",
          "service": "backend",
          "url": "http://localhost:${DEV_API_PORT}/admin/",
          "validity": "valid",
          "resolution_status": "resolved"
        },
        {
          "environment": "dev",
          "service": "frontend",
          "url": "http://localhost:${DEV_VITE_PORT}",
          "validity": "valid",
          "resolution_status": "resolved"
        },
        {
        ...
        },
        {
          "environment": "prod",
          "service": "backend",
          "url": "https://cal.mon-site.ca/admin/",
          "validity": "valid",
          "resolution_status": "resolved"
        },
        {
          "environment": "prod",
          "service": "backend",
          "url": "https://cal.mon-site.ca/static/",
          "validity": "valid",
          "resolution_status": "resolved"
        },
        {
