...
Titre de section : Variables de configuration, noms uniquement
Identifiant de section : operator-environment-variables
But : Fournir la liste déterministe des noms de variables.
Budget de contexte estimé : 383/12288 tokens.
Produis uniquement la section demandée, sans titre de document global, sans conclusion générale et sans contenu hors sujet.
END INSTRUCTIONS

BEGIN SECTION FACTS
{
  "identifier": "operator-environment-variables",
  "title": "Variables de configuration, noms uniquement",
  "purpose": "Fournir la liste déterministe des noms de variables.",
  "facts": {
    "environment_variables": {
      "variables": [
        {
          "name": "ACCESS_TOKEN_LIFETIME_MIN",
          "sensitive": true
        },
        {
          "name": "ADMIN_EMAIL",
        ...
        {
          "name": "CONTACT_API_BASE",
          "sensitive": false
        },
        {
          "name": "CONTACT_API_TIMEOUT",
          "sensitive": false
        },
        {
