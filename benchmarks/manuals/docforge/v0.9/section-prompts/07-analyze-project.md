...
Titre de section : Analyse d’un projet
Identifiant de section : analyze-project
But : Décrire le flux d’analyse d’un projet local.
Taille estimée du contexte : 95 tokens.
