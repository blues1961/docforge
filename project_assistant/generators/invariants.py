...
class InvariantsDocumentGenerator:
    def generate(
        ...
        lines = [
            ...
            "- `.env.local` ne doit jamais être versionné, lu ou affiché par project-assistant;",
        ...
        lines.extend(
            [
                ...
                "- `project-assistant apply` ne doit pas intégrer `INVARIANTS.md` sans approbation explicite;",
